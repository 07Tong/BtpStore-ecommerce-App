...
from BtpStorecom import aws_manager
...
class Image(models.Model):
    ...
    def clean(self):
        if self.name and self.aws_image:
            ...
            object_path = f'BtpStorecom/products/{self.aws_key}/{self.aws_slug_name}'
...
class ProductCollection(models.Model):
    ...
    gender = models.CharField(max_length=50, choices=GenderChoices.choices, default=GenderChoices.GROSOEUVRE)
...
class Product(models.Model):
    ...
    google_category = models.CharField(max_length=5,
        choices=GoogleProductCategory.choices, default=GoogleProductCategory.ELECTRICPLOM)
    ...
    def get_absolute_url(self):
        ...
        return reverse('product', args=['grosoeuvre', collection_name, self.pk, self.slug])
