...
class UserView(LoginRequiredMixin, generic.DetailView):
    ...
    def post(self, request, **kwargs):
        ...
        try:
            user.email_user('subject', 'message', from_email='contact.btpstorecom@gmail.com')#créer cette adresse
        except:
    ...
    if products:
        ...
        for product in products:
            ...
            if export_for == 'facebook':
                ...
                if product.gender == 'femme':#modifier
                    gender = 'female'#modifier
                else:
                    gender = 'male'#modifier
                rows.append(
                    [
                        product.id,
                        product.name,
