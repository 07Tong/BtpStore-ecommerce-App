    ...
    def post(self, request, **kwargs):
        ...
        try:
            send_mail(
                ...
                from_email='contact.btpstorecom@gmail.com',
                recipient_list = [
                    'contact.btpstorecom@gmail.com'
                ],
                html_message = """
                Bonjour,
        ...
        messages.error(request, "Merci de nous avoir contacté", extra_tags='alert-success')
        return redirect('customer_care')
