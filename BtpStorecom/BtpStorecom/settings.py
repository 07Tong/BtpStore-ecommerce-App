"""
Django settings for BtpStorecom project.
...
# SECURITY WARNING: keep the secret key used in production secret! to do /
SECRET_KEY = 'django-insecure-)pikz)9hy5_^^r-ty6e6-%x&b8h0n!zw&_lnlma_+5a!3^$y=!'
SECRET_KEY = os.environ.get('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'BtpStorecom.cm',
                 '*.BtpStorecom.cm', '30f4e9938de6.ngrok.io', 'testserver']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'BtpStorecom.responsive.responsive_context_processor'
            ],
            'libraries': {
...
WSGI_APPLICATION = 'BtpStorecom.wsgi.application'
...
APPLE_PAY_DOMAIN = 'BtpStorecom.cm'
